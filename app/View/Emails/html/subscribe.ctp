			...
			<table>
				<tr>
					<td>
						...
						<p>Congratulations! You have subscribed to a public records request that was made to the <?php echo $agencyName; ?>. You will receive email updates about the request, but you can always view any activity on the request page, <a href='<?php echo Router::fullbaseUrl().$page; ?>'><?php echo Router::fullbaseUrl().$page; ?></a>.</p>
						<!-- social & contact -->
						<table width="100%">
							<tr>
								<td>
